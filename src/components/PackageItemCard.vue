<template>
  <div
    ...
    @click="onClick"
  >
    <img v-if="data.organization.image_url" :src="getImageUrl(data.organization.image_url)" class="mb-4 mx-4 h-20 w-auto self-center" />
    <i-mdi:file v-if="!data.organization.image_url" class="mb-4 mx-4 h-20 w-auto self-center text-secondary" />
